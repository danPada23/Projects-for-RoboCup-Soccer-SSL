%--Logica fsm ed azioni da svolgere
        function [u1_p, u2_p] = decide_action(obj, bot_player, bot_enemy, palla, campo, X_max, Y_max, d)
            ...
            % OVERRIDE STOP: Se la palla si sta muovendo velocemente, FORZA lo STOP.
            stop_ball = 0.05;
            if vel_palla > stop_ball
                obj.fsm_state = 7;
                obj.calcolo_effettuato = false;
            end
            % OVERRIDE Fuga: Valutato SOLO se la palla è ferma o quasi ferma.
            ...
            switch obj.fsm_state
                ...
                case 7 % STOP (Congelamento)
                    ...
                    % Histeresi: esce dallo stop solo quando è VERAMENTE ferma
                    if vel_palla < 0.005
