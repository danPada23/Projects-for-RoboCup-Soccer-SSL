...
% --- SETUP GRAFICA ---
% ==========================================
Scenario = figure('Name','Billiard Robot Simulator - 2vs2 Match', 'NumberTitle','off', 'Position', [100, 100, 800, 600]);
hold on; axis equal;
margine_camera = 0.08;
...
% % Testo che mostra il valore in tempo reale
% txt_radius = uicontrol('Style', 'text', ...
%     'Position', [20, 50, 160, 20], ...
%     'String', sprintf('Reception Radius: %.2f', reception_radius), ...
%     'FontSize', 10, 'FontWeight', 'bold', ...
%     'BackgroundColor', 'white');
% 
% % % Testo con sfondo scuro e scritta bianca o ciano
% % txt_radius = uicontrol('Style', 'text', ...
% %     'Position', [20, 50, 160, 20], ...
% %     'String', sprintf('Reception Radius: %.2f', reception_radius), ...
% %     'FontSize', 10, 'FontWeight', 'bold', ...
% %     'BackgroundColor', [0.2 0.2 0.2], ... % Sfondo grigio molto scuro
% %     'ForegroundColor', 'cyan');           % Testo azzurro neon
% 
% % Slider impostato con 5 scatti lineari e binario scuro per contrasto
% sld_radius = uicontrol('Style', 'slider', ...
%     'Min', 0.05, 'Max', 0.25, ...
%     'Value', reception_radius, ...
%     'Position', [20, 20, 160, 20], ...
%     'SliderStep', [0.25, 0.25], ...
%     'BackgroundColor', [0.5 0.5 0.5], ... % <-- IL TRUCCO È QUI (Grigio Scuro)
